...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            featured_image: "",
            apiUrl:
                "https://briandeanullery.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post",
        };
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://briandeanullery.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch",
            });
        }
    }
    ...
    handleSubmit(event) {
        axios({
            ...
            .catch((error) => {
                console.log(
                    "handleSuccessfulFormSubmission ERRRRRORRRRRRR!!!!!",
                    error
                );
            });
